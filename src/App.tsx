...
function App() {
  ...
  const [isHome, setIsHome] = useState("Webbal");
      ...
      <div className={isDark ? "dark" : ""}>
        <div className="bg-neutral-100 dark:bg-neutral-900 font-display h-full">
          ...
          >
            <div
              onClick={handleHome}
              className={isHome === "Webbal" ? "opacity-0" : "opacity-100"}
            >
              <Link
                className={
                  isHome === "Webbal" ? "cursor-default" : "cursor-pointer"
                }
                to={isHome === "Webbal" ? "/" : ""}
              >
                <svg
